...
public class Utility {
    ...
    public static void updateArrayLists(String textFirst, String textSecond, String textThird, int style) {

        // REPOPULATE THE ARRAYLISTS DEPENDING ON RESULTS

        ApplicationController.getInstance().getTextFirstArray().add(textFirst);

        ApplicationController.getInstance().getTextSecondArray().add(textSecond);

        ApplicationController.getInstance().getTextThirdArray().add(textThird);

        ApplicationController.getInstance().getStyleArray().add(String.valueOf(style));
    }
}
